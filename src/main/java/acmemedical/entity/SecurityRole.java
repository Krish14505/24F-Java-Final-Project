...
/**
 * Role class used for (JSR-375) Jakarta EE Security
 * authorization/authentication
 */
//TODO SR01 - Make this into JPA entity and add all necessary annotations inside the class.
@Entity // SR01 - Makes this a JPA entity
@Table(name = "security_role") // SR01 - Maps the entity to the security_role table
@NamedQuery(
